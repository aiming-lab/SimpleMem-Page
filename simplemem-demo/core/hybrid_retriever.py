...
- Dynamic retrieval depth k_dyn = k_base · (1 + δ · C_q) (Eq. 9)
...
class HybridRetriever:
    ...
    2. Hybrid Scoring Function S(q, m_k): Eq. (7) - aggregates multi-layer signals
    3. Complexity-Aware Pruning: Eq. (8-9) - dynamic depth based on C_q
